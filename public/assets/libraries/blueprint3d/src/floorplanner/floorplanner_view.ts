...
module BP3D.Floorplanner {
  ...
  export class FloorplannerView {
    ...
    private calculateSqFt(X,Y) {
        var numPoints = X.length;
        var area: number = 0;         // Accumulates area in the loop
        var j: number = numPoints-1;  // The last vertex is the 'previous' one to the first
